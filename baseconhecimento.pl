...
if japonesa and entrega_sim and custo_sim then 7.
if braga and acessivel and entrega_sim then 8.
if mexicana and entrega_sim and custo_sim then 9.
...
if saudavel and braga and acessivel and entrega_sim and custo_nao then 15.
